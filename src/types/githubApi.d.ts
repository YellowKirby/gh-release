...
export interface GQLQuery {
  ...
  codesOfConduct?: (GQLCodeOfConduct | null)[];
  license?: GQLLicense;
  licenses: (GQLLicense | null)[];
  marketplaceCategories: GQLMarketplaceCategory[];
...
export interface GQLLicense {
  body: string;
  conditions: (GQLLicenseRule | null)[];
  description?: string;
  featured: boolean;
  hidden: boolean;
  id: string;
  ...
  key: string;
  limitations: (GQLLicenseRule | null)[];
  name: string;
  nickname?: string;
  permissions: (GQLLicenseRule | null)[];
...
export interface GQLMarketplaceCategory {
  description?: string;
  howItWorks?: string;
  name: string;
...
export interface GQLMarketplaceListingConnection {
  edges?: (GQLMarketplaceListingEdge | null)[];
  nodes?: (GQLMarketplaceListing | null)[];
...
export interface GQLOrganization extends GQLActor, GQLNode, GQLProjectOwner, GQLRepositoryOwner, GQLUniformResourceLocatable {
  avatarUrl: GQLURI;
  databaseId?: number;
  description?: string;
  email?: string;
...
export interface GQLProjectColumnConnection {
  edges?: (GQLProjectColumnEdge | null)[];
  nodes?: (GQLProjectColumn | null)[];
  pageInfo: GQLPageInfo;
  totalCount: number;
}
...
export interface GQLProjectCardConnection {
  edges?: (GQLProjectCardEdge | null)[];
  nodes?: (GQLProjectCard | null)[];
  pageInfo: GQLPageInfo;
  totalCount: number;
}
...
export interface GQLIssue extends GQLAssignable, GQLClosable, GQLComment, GQLLabelable, GQLLockable, GQLNode, GQLReactable, GQLRepositoryNode, GQLSubscribable, GQLUniformResourceLocatable, GQLUpdatable, GQLUpdatableComment {
  ...
  viewerCanUpdate: boolean;
  viewerCannotUpdateReasons: GQLCommentCannotUpdateReason[];
...
export interface GQLUser extends GQLActor, GQLNode, GQLRepositoryOwner, GQLUniformResourceLocatable {
  avatarUrl: GQLURI;
  bio?: string;
  bioHTML: GQLHTML;
   ...
   */
  contributedRepositories: GQLRepositoryConnection;
  createdAt: GQLDateTime;
  databaseId?: number;
  email: string;
...
export interface GQLRepositoryConnection {
  edges?: (GQLRepositoryEdge | null)[];
  nodes?: (GQLRepository | null)[];
  pageInfo: GQLPageInfo;
  totalCount: number;
...
export interface GQLRepository extends GQLNode, GQLProjectOwner, GQLRepositoryInfo, GQLStarrable, GQLSubscribable, GQLUniformResourceLocatable {
...
export type GQLPossibleStarrableTypeNames = 'Repository' | 'Gist';
...
export interface GQLRepositoryCollaboratorConnection {
  edges?: (GQLRepositoryCollaboratorEdge | null)[];
  nodes?: (GQLUser | null)[];
  pageInfo: GQLPageInfo;
  totalCount: number;
}
...
export interface GQLCommitCommentConnection {
  edges?: (GQLCommitCommentEdge | null)[];
  nodes?: (GQLCommitComment | null)[];
  pageInfo: GQLPageInfo;
  totalCount: number;
}
...
export interface GQLUserContentEditConnection {
  edges?: (GQLUserContentEditEdge | null)[];
  nodes?: (GQLUserContentEdit | null)[];
  pageInfo: GQLPageInfo;
  totalCount: number;
}
...
export interface GQLReactingUserConnection {
  edges?: (GQLReactingUserEdge | null)[];
  nodes?: (GQLUser | null)[];
  pageInfo: GQLPageInfo;
  totalCount: number;
}
...
export interface GQLReactionConnection {
  edges?: (GQLReactionEdge | null)[];
  nodes?: (GQLReaction | null)[];
  pageInfo: GQLPageInfo;
  totalCount: number;
  viewerHasReacted: boolean;
}
...
export interface GQLCommit extends GQLGitObject, GQLNode, GQLSubscribable {
...
export interface GQLCommitHistoryConnection {
  edges?: (GQLCommitEdge | null)[];
  nodes?: (GQLCommit | null)[];
  pageInfo: GQLPageInfo;
  totalCount: number;
}
...
export interface GQLPullRequestConnection {
  edges?: (GQLPullRequestEdge | null)[];
  nodes?: (GQLPullRequest | null)[];
  pageInfo: GQLPageInfo;
  totalCount: number;
}
...
export interface GQLPullRequest extends GQLAssignable, GQLClosable, GQLComment, GQLLabelable, GQLLockable, GQLNode, GQLReactable, GQLRepositoryNode, GQLSubscribable, GQLUniformResourceLocatable, GQLUpdatable, GQLUpdatableComment {
  ...
  suggestedReviewers: (GQLSuggestedReviewer | null)[];
...
export interface GQLIssueCommentConnection {
  edges?: (GQLIssueCommentEdge | null)[];
  nodes?: (GQLIssueComment | null)[];
  pageInfo: GQLPageInfo;
  totalCount: number;
}
...
export interface GQLPullRequestCommitConnection {
  edges?: (GQLPullRequestCommitEdge | null)[];
  nodes?: (GQLPullRequestCommit | null)[];
  pageInfo: GQLPageInfo;
  totalCount: number;
}
...
export interface GQLReviewRequestConnection {
  edges?: (GQLReviewRequestEdge | null)[];
  nodes?: (GQLReviewRequest | null)[];
  pageInfo: GQLPageInfo;
  totalCount: number;
}
...
export interface GQLOrganizationInvitationConnection {
  edges?: (GQLOrganizationInvitationEdge | null)[];
  nodes?: (GQLOrganizationInvitation | null)[];
  pageInfo: GQLPageInfo;
  totalCount: number;
}
...
export interface GQLTeamRepositoryConnection {
  edges?: (GQLTeamRepositoryEdge | null)[];
  nodes?: (GQLRepository | null)[];
  pageInfo: GQLPageInfo;
  totalCount: number;
}
...
export interface GQLPullRequestReviewConnection {
  edges?: (GQLPullRequestReviewEdge | null)[];
  nodes?: (GQLPullRequestReview | null)[];
  pageInfo: GQLPageInfo;
  totalCount: number;
}
...
export interface GQLPullRequestReviewCommentConnection {
  edges?: (GQLPullRequestReviewCommentEdge | null)[];
  nodes?: (GQLPullRequestReviewComment | null)[];
  pageInfo: GQLPageInfo;
  totalCount: number;
}
...
export interface GQLPullRequestTimelineConnection {
  edges?: (GQLPullRequestTimelineItemEdge | null)[];
  nodes?: (GQLPullRequestTimelineItem | null)[];
  pageInfo: GQLPageInfo;
  totalCount: number;
}
...
export interface GQLClosedEvent extends GQLNode {
  actor?: GQLActor;
  closable: GQLClosable;
  closer?: GQLCloser;
...
export interface GQLDeploymentStatusConnection {
  edges?: (GQLDeploymentStatusEdge | null)[];
  nodes?: (GQLDeploymentStatus | null)[];
  pageInfo: GQLPageInfo;
  totalCount: number;
}
...
export interface GQLDeployKeyConnection {
  edges?: (GQLDeployKeyEdge | null)[];
  nodes?: (GQLDeployKey | null)[];
  pageInfo: GQLPageInfo;
  totalCount: number;
}
...
export interface GQLDeploymentConnection {
  edges?: (GQLDeploymentEdge | null)[];
  nodes?: (GQLDeployment | null)[];
  pageInfo: GQLPageInfo;
  totalCount: number;
}
...
export interface GQLLanguageConnection {
  edges?: (GQLLanguageEdge | null)[];
  nodes?: (GQLLanguage | null)[];
  pageInfo: GQLPageInfo;
  totalCount: number;
  totalSize: number;
}
...
export interface GQLMilestoneConnection {
  edges?: (GQLMilestoneEdge | null)[];
  nodes?: (GQLMilestone | null)[];
  pageInfo: GQLPageInfo;
  totalCount: number;
}
...
export interface GQLProjectConnection {
  edges?: (GQLProjectEdge | null)[];
  nodes?: (GQLProject | null)[];
  pageInfo: GQLPageInfo;
  totalCount: number;
}
...
export interface GQLProtectedBranchConnection {
  edges?: (GQLProtectedBranchEdge | null)[];
  nodes?: (GQLProtectedBranch | null)[];
  pageInfo: GQLPageInfo;
  totalCount: number;
}
...
export interface GQLPushAllowanceConnection {
  edges?: (GQLPushAllowanceEdge | null)[];
  nodes?: (GQLPushAllowance | null)[];
  pageInfo: GQLPageInfo;
  totalCount: number;
}
...
export interface GQLReviewDismissalAllowanceConnection {
  edges?: (GQLReviewDismissalAllowanceEdge | null)[];
  nodes?: (GQLReviewDismissalAllowance | null)[];
  pageInfo: GQLPageInfo;
  totalCount: number;
}
...
export interface GQLReleaseAssetConnection {
  edges?: (GQLReleaseAssetEdge | null)[];
  nodes?: (GQLReleaseAsset | null)[];
  pageInfo: GQLPageInfo;
  totalCount: number;
}
...
export interface GQLReleaseConnection {
  edges?: (GQLReleaseEdge | null)[];
  nodes?: (GQLRelease | null)[];
  pageInfo: GQLPageInfo;
  totalCount: number;
}
...
export interface GQLRepositoryTopicConnection {
  edges?: (GQLRepositoryTopicEdge | null)[];
  nodes?: (GQLRepositoryTopic | null)[];
  pageInfo: GQLPageInfo;
  totalCount: number;
}
...
export interface GQLGistCommentConnection {
  edges?: (GQLGistCommentEdge | null)[];
  nodes?: (GQLGistComment | null)[];
  pageInfo: GQLPageInfo;
  totalCount: number;
}
...
export interface GQLOrganizationConnection {
  edges?: (GQLOrganizationEdge | null)[];
  nodes?: (GQLOrganization | null)[];
  pageInfo: GQLPageInfo;
  totalCount: number;
}
...
export interface GQLPublicKeyConnection {
  edges?: (GQLPublicKeyEdge | null)[];
  nodes?: (GQLPublicKey | null)[];
  pageInfo: GQLPageInfo;
  totalCount: number;
}
...
export interface GQLStarredRepositoryConnection {
  edges?: (GQLStarredRepositoryEdge | null)[];
  nodes?: (GQLRepository | null)[];
  pageInfo: GQLPageInfo;
  totalCount: number;
}
...
export interface GQLIssueTimelineConnection {
  edges?: (GQLIssueTimelineItemEdge | null)[];
  nodes?: (GQLIssueTimelineItem | null)[];
  pageInfo: GQLPageInfo;
  totalCount: number;
}
...
export interface GQLExternalIdentityConnection {
  edges?: (GQLExternalIdentityEdge | null)[];
  nodes?: (GQLExternalIdentity | null)[];
  pageInfo: GQLPageInfo;
  totalCount: number;
}
...
export interface GQLSearchResultItemConnection {
  codeCount: number;
  edges?: (GQLSearchResultItemEdge | null)[];
  issueCount: number;
  nodes?: (GQLSearchResultItem | null)[];
  pageInfo: GQLPageInfo;
...
export interface GQLTextMatch {
  fragment: string;
  highlights: (GQLTextMatchHighlight | null)[];
  property: string;
}
...
export interface GQLAddPullRequestReviewInput {
  body?: string;
  clientMutationId?: string;
  comments?: (GQLDraftPullRequestReviewComment | null)[];
...
export interface GQLNodeTypeResolver<TParent = any> {
  (parent: TParent, context: any, info: GraphQLResolveInfo): 'MarketplaceListing' | 'Organization' | 'Project' | 'ProjectColumn' | 'ProjectCard' | 'Issue' | 'User' | 'Repository' | 'CommitComment' | 'UserContentEdit' | 'Reaction' | 'Commit' | 'Status' | 'StatusContext' | 'Tree' | 'Ref' | 'PullRequest' | 'Label' | 'IssueComment' | 'PullRequestCommit' | 'Milestone' | 'ReviewRequest' | 'Team' | 'OrganizationInvitation' | 'PullRequestReview' | 'PullRequestReviewComment' | 'AssignedEvent' | 'BaseRefForcePushedEvent' | 'ClosedEvent' | 'CommitCommentThread' | 'CrossReferencedEvent' | 'DemilestonedEvent' | 'DeployedEvent' | 'Deployment' | 'DeploymentStatus' | 'HeadRefDeletedEvent' | 'HeadRefForcePushedEvent' | 'HeadRefRestoredEvent' | 'LabeledEvent' | 'LockedEvent' | 'MergedEvent' | 'MilestonedEvent' | 'PullRequestReviewThread' | 'ReferencedEvent' | 'RenamedTitleEvent' | 'ReopenedEvent' | 'ReviewDismissedEvent' | 'ReviewRequestRemovedEvent' | 'ReviewRequestedEvent' | 'SubscribedEvent' | 'UnassignedEvent' | 'UnlabeledEvent' | 'UnlockedEvent' | 'UnsubscribedEvent' | 'DeployKey' | 'Language' | 'ProtectedBranch' | 'PushAllowance' | 'ReviewDismissalAllowance' | 'Release' | 'ReleaseAsset' | 'RepositoryTopic' | 'Topic' | 'Gist' | 'GistComment' | 'PublicKey' | 'OrganizationIdentityProvider' | 'ExternalIdentity' | 'AddedToProjectEvent' | 'BaseRefChangedEvent' | 'Blob' | 'Bot' | 'CommentDeletedEvent' | 'ConvertedNoteToIssueEvent' | 'MentionedEvent' | 'MovedColumnsInProjectEvent' | 'RemovedFromProjectEvent' | 'RepositoryInvitation' | 'Tag';
}
...
export interface OrganizationToPinnedRepositoriesArgs {
  affiliations?: (GQLRepositoryAffiliation | null)[];
  after?: string;
  before?: string;
  first?: number;
  isLocked?: boolean;
...
export interface GQLUpdatableTypeResolver<TParent = any> {
  (parent: TParent, context: any, info: GraphQLResolveInfo): 'Project' | 'Issue' | 'CommitComment' | 'PullRequest' | 'IssueComment' | 'PullRequestReview' | 'PullRequestReviewComment' | 'GistComment';
}
...
export interface GQLProjectCardTypeResolver<TParent = any> {
  ...
  projectColumn?: ProjectCardToProjectColumnResolver<TParent>;
...
export interface ProjectCardToProjectColumnResolver<TParent = any, TResult = any> {
  (parent: TParent, args: {}, context: any, info: GraphQLResolveInfo): TResult;
}
...
export interface GQLUserTypeResolver<TParent = any> {
  ...
  contributedRepositories?: UserToContributedRepositoriesResolver<TParent>;
...
export interface UserToContributedRepositoriesArgs {
  affiliations?: (GQLRepositoryAffiliation | null)[];
  after?: string;
  before?: string;
  first?: number;
...
export interface UserToContributedRepositoriesResolver<TParent = any, TResult = any> {
  (parent: TParent, args: UserToContributedRepositoriesArgs, context: any, info: GraphQLResolveInfo): TResult;
}
...
export interface UserToRepositoriesContributedToArgs {
  after?: string;
  before?: string;
  contributionTypes?: (GQLRepositoryContributionType | null)[];
  first?: number;
...
export interface GQLRepositoryTypeResolver<TParent = any> {
  ...
  license?: RepositoryToLicenseResolver<TParent>;
...
export interface RepositoryToLicenseResolver<TParent = any, TResult = any> {
  (parent: TParent, args: {}, context: any, info: GraphQLResolveInfo): TResult;
}
...
export interface GQLStarrableTypeResolver<TParent = any> {
  (parent: TParent, context: any, info: GraphQLResolveInfo): 'Repository' | 'Gist';
}
...
export interface GQLSubscribableTypeResolver<TParent = any> {
  (parent: TParent, context: any, info: GraphQLResolveInfo): 'Issue' | 'Repository' | 'Commit' | 'PullRequest' | 'Team';
}
export interface GQLUniformResourceLocatableTypeResolver<TParent = any> {
  (parent: TParent, context: any, info: GraphQLResolveInfo): 'Organization' | 'Issue' | 'User' | 'Repository' | 'PullRequest' | 'PullRequestCommit' | 'Milestone' | 'CrossReferencedEvent' | 'MergedEvent' | 'ReviewDismissedEvent' | 'Release' | 'RepositoryTopic' | 'Bot';
}
...
export interface GQLCommentTypeResolver<TParent = any> {
  (parent: TParent, context: any, info: GraphQLResolveInfo): 'Issue' | 'CommitComment' | 'PullRequest' | 'IssueComment' | 'PullRequestReview' | 'PullRequestReviewComment' | 'GistComment';
}
...
export interface GQLDeletableTypeResolver<TParent = any> {
  (parent: TParent, context: any, info: GraphQLResolveInfo): 'CommitComment' | 'IssueComment' | 'PullRequestReview' | 'PullRequestReviewComment' | 'GistComment';
}
export interface GQLReactableTypeResolver<TParent = any> {
  (parent: TParent, context: any, info: GraphQLResolveInfo): 'Issue' | 'CommitComment' | 'PullRequest' | 'IssueComment' | 'PullRequestReviewComment';
}
...
export interface GQLRepositoryNodeTypeResolver<TParent = any> {
  (parent: TParent, context: any, info: GraphQLResolveInfo): 'Issue' | 'CommitComment' | 'PullRequest' | 'IssueComment' | 'PullRequestReview' | 'PullRequestReviewComment' | 'CommitCommentThread';
}
...
export interface PullRequestToReviewsArgs {
  ...
  first?: number;
  last?: number;
  states?: GQLPullRequestReviewState[];
}
...
export interface GQLReviewRequestTypeResolver<TParent = any> {
  ...
  reviewer?: ReviewRequestToReviewerResolver<TParent>;
}
...
export interface ReviewRequestToReviewerResolver<TParent = any, TResult = any> {
  (parent: TParent, args: {}, context: any, info: GraphQLResolveInfo): TResult;
}
...
export interface GQLClosedEventTypeResolver<TParent = any> {
  ...
  commit?: ClosedEventToCommitResolver<TParent>;
...
export interface ClosedEventToCommitResolver<TParent = any, TResult = any> {
  (parent: TParent, args: {}, context: any, info: GraphQLResolveInfo): TResult;
}
...
export interface GQLReferencedEventTypeResolver<TParent = any> {
  ...
  isCrossReference?: ReferencedEventToIsCrossReferenceResolver<TParent>;
...
export interface ReferencedEventToIsCrossReferenceResolver<TParent = any, TResult = any> {
  (parent: TParent, args: {}, context: any, info: GraphQLResolveInfo): TResult;
}
...
export interface GQLReviewRequestRemovedEventTypeResolver<TParent = any> {
  ...
  subject?: ReviewRequestRemovedEventToSubjectResolver<TParent>;
}
...
export interface ReviewRequestRemovedEventToSubjectResolver<TParent = any, TResult = any> {
  (parent: TParent, args: {}, context: any, info: GraphQLResolveInfo): TResult;
}
...
export interface GQLReviewRequestedEventTypeResolver<TParent = any> {
  ...
  subject?: ReviewRequestedEventToSubjectResolver<TParent>;
}
...
export interface ReviewRequestedEventToSubjectResolver<TParent = any, TResult = any> {
  (parent: TParent, args: {}, context: any, info: GraphQLResolveInfo): TResult;
}
...
export interface GQLIssueTimelineItemTypeResolver<TParent = any> {
  (parent: TParent, context: any, info: GraphQLResolveInfo): 'AssignedEvent' | 'ClosedEvent' | 'Commit' | 'CrossReferencedEvent' | 'DemilestonedEvent' | 'IssueComment' | 'LabeledEvent' | 'LockedEvent' | 'MilestonedEvent' | 'ReferencedEvent' | 'RenamedTitleEvent' | 'ReopenedEvent' | 'SubscribedEvent' | 'UnassignedEvent' | 'UnlabeledEvent' | 'UnlockedEvent' | 'UnsubscribedEvent';
}
